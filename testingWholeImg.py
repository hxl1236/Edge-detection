...
def brightness(img, min_contour_area_threshold, max_contour_area_threshold):
    ...
    cv2.imshow('dark', high_contrast_result)
    cv2.waitKey(0)
...
if __name__ == "__main__":
    ...
    min_dark_contour_area_threshold = 5 #200
    max_dark_contour_area_threshold = 300 #2500
    ...
    min_bright_contour_area_threshold = 0 #260
    max_bright_contour_area_threshold = 10000 #1000
    ...
    filtered_contours = [contour for contour in all_contours if cv2.contourArea(contour) >= 20 and cv2.contourArea(contour) <=150]#570
